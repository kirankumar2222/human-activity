"""analysis_on_benefits_and_costs URL Configuration
...
from analysis_on_benefits_and_costs import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Early_Hospitalization_Type/$', remoteuser.Predict_Early_Hospitalization_Type, name="Predict_Early_Hospitalization_Type"),
    ...
    url(r'^View_Early_Hospitalization_Type_Ratio/$', serviceprovider.View_Early_Hospitalization_Type_Ratio, name="View_Early_Hospitalization_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Early_Hospitalization_Type/$', serviceprovider.View_Prediction_Of_Early_Hospitalization_Type, name="View_Prediction_Of_Early_Hospitalization_Type"),
